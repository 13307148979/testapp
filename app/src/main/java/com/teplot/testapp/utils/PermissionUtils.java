...
//    }
    ...
    private static void showMessageOKCancel(final Activity context, String message, DialogInterface.OnClickListener okListener) {
        showExitDlg(context,message,okListener);
    }
    private static void showExitDlg( Activity context,String text,DialogInterface.OnClickListener okListener) {
        ConfireDlg exitDlg = new ConfireDlg.Builder(context).setTitle("警告")
                .setCancelable(false)
                .setContent(text)
                .setYesButton("去开启",okListener)
                .create();
        exitDlg.show();
    }
    /**
    ...
    public static void requestPermissionsResult(final Activity activity, final int requestCode, @NonNull String[] permissions,
        ...
        if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            //TODO
            String[] permissionsHint = activity.getResources().getStringArray(R.array.permissions);
            openSettingActivity(activity, permissionsHint[requestCode]);//========>"Result" +
        }
    }
     ...
     * @param grantResults
     */
    public static void requestPermissionsResult2(final Activity activity, final int requestCode, @NonNull String[] permissions,
                                                 @NonNull int[] grantResults, PermissionGrant permissionGrant,
                                                 final int request) {
        ...
        if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
            ...
            //TODO
            String[] permissionsHint = activity.getResources().getStringArray(R.array.permissions);
            openSettingActivity2(activity, permissionsHint[requestCode],request);//========>"Result" +
        }
    }
    private static void openSettingActivity2(final Activity activity, String message,final int request) {
