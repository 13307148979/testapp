...
//    private final int DFT_TRANSENDY = 300;
     ...
     */
    public void setTransView(View transView,int start,int end) {
        setTransView(transView, getResources().getColor(R.color.blue), Utils.dip2px(getContext(), start), Utils.dip2px(getContext(), end));
    }
...
//    public void setTransView2(View transView, Drawable  drawable, int transStartY, int transEndY) {
//        this.transView = transView;
//        //初始视图-透明
//        this.transView.setBackgroundColor(ColorUtils.setAlphaComponent(drawable, 0));
//        this.transView.setBackgroundResource(drawable);
//        this.transStartY = transStartY;
//        this.transEndY = transEndY;
//        this.transColor = transColor;
//        if (transStartY > transEndY) {
