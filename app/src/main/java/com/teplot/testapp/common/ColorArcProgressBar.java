...
public class ColorArcProgressBar extends View{
    ...
    private int mWidth;
    private int mHeight;
    private int diameter = dipToPx(80);  //直径
    ...
    private float longdegree = dipToPx(3);
    private float shortdegree = dipToPx(1);
    private final int DEGREE_PROGRESS_DISTANCE = dipToPx(2);

    private String hintColor = "#FF35BAF0";
    private String longDegreeColor = "#111111";
    private String shortDegreeColor = "#111111";
    private String bgArcColor = "#6CCAF4";
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        sweepAngle = a.getInteger(R.styleable.ColorArcProgressBar_total_engle, 300);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(centerX, centerY, dipToPx(30), bigCirclePaint);
        //整个弧
