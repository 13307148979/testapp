        ...
        for (int i = ignoreCalcLength + 1; i < text.length(); i++) {
            if (paint.measureText(text.substring(startPosition, i + 1)) > width) {
                ...
                if ((text.length() - startPosition) > ignoreCalcLength) {
                   // System.out.println("AlignTextView3==为空=>"+text.charAt(startPosition));
                    sb.append(text.substring(startPosition, startPosition + ignoreCalcLength));
                } else {
                    if (!Character.isSpace(text.charAt(startPosition))){
                        //System.out.println("AlignTextView1==不为空=>"+text.charAt(startPosition));
              ...
              //System.out.println("AlignTextView2==为空=>"+text.charAt(startPosition));
