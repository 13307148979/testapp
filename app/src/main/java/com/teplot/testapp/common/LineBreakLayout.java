...
import com.teplot.testapp.been.details.ChooseData;
...
public class LineBreakLayout extends ViewGroup {
     ...
     * 所有标签
     */
    private List<ChooseData> lables;
    /**
     * 选中标签
     */
    //private List<ChooseData> lableSelected = new ArrayList<>();
    ...
    public LineBreakLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LEFT_RIGHT_SPACE = ta.getDimensionPixelSize(R.styleable.LineBreakLayout_leftAndRightSpace, 14);
        ROW_SPACE = ta.getDimensionPixelSize(R.styleable.LineBreakLayout_rowSpace, 14);
        ta.recycle(); //回收
     ...
     * @param add 是否追加
     */
    public void setLables(List<ChooseData> lables, boolean add){
        ...
        if(lables!=null && lables.size()>0){
            ...
            for ( int i= 0;i<lables.size(); i++){
                ...
                final int current = i;
                final ChooseData lable = lables.get(i);
                //获取标签布局
                final View view = inflater.inflate(R.layout.item_gridview_string, null);

                final TextView tv = view.findViewById(R.id.text_item_grid);
                textViews.add(tv);
                tv.setText(lable.getText());
                //设置选中效果\
                //未选中
                ...
                tv.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        mOnItemDetailListener.onClick(current,tv);
                    }
                });
                //将标签添加到容器中
                addView(view);
...
//                //获取标签布局
//                View view = inflater.inflate(R.layout.item_gridview_string, null);
//
//                final TextView tv = view.findViewById(R.id.text_item_grid);
//                tv.setText(lable);
//                //设置选中效果
...
//                    //选中
//                    tv.setTextColor(getResources().getColor(R.color.gridview_choose));
//                    //tv.setBackgroundResource(R.drawable.gridview_choose_shape_background);
//                    tv.setSelected(true);
////                    tv.setTextColor(getResources().getColor(R.color.tv_blue));
//                } else {
//                    //未选中
//                    tv.setTextColor(getResources().getColor(R.color.hint_text));
//                    //tv.setBackgroundResource(R.drawable.gridview_unchoose_shape_background);
//                    tv.setSelected(false);
...
//            }
    ...
    public interface onItemDetailListener {
        void onClick(int current, TextView tv);
    }
     ...
     * 获取选中标签
     */
//    public List<ChooseData> getSelectedLables(){
