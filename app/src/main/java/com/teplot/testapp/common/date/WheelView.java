 ...
 */
@SuppressLint({ "FloatMath", "ClickableViewAccessibility", "HandlerLeak" })
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF333333;//0xffff0000;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR =0xFF999999;//0xFF000000;#
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = (int)(AppData.DENSITY*20);;

	/** Text size */
	private static final int TEXT_SIZE = (int)(AppData.DENSITY*14);
	private static final int TEXT_SIZE_value = (int)(AppData.DENSITY*14);
	...
	private Paint  mPaintRectCenter,mPaintLineCenter;
	...
	private void initData(Context context) {
		...
		mPaintLineCenter.setColor(AppContext.getInstance().getResources().getColor(R.color.main_backcolor));//(0xffe8e8e8);
...
//		mPaintRectCenter.setColor(0xffffffff);
...
//		mPaintRectCenter.setStyle(Paint.Style.FILL);
	...
	private void initResourcesIfNecessary() {
		...
		if (valuePaint == null) {
			...
			valuePaint.setTextSize(TEXT_SIZE_value);
			//valuePaint.setShadowLayer(0.1f, 0, 0.1f, 0xffff0000);//0xFFC0C0C0);
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.wheel_val);//wheel_val
		}
...
//		centerDrawable.draw(canvas);
	...
	private SimpleOnGestureListener gestureListener = new SimpleOnGestureListener() {
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
			...
			int maxY = isCyclic ? 0x7FFFFFFF : adapter.getItemsCount() * getItemHeight();//0x7FFFFFFF
