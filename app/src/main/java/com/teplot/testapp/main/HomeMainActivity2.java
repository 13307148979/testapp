 ...
 * 监测界面
 */
public class HomeMainActivity2 extends BaseActivity {
    ...
    private void initHeadView(){
        int height = Utils.getStatusBarHeight(HomeMainActivity2.this);
    ...
    public void showPermissionCONTENT() {
        // type = "1";
        PermissionUtils.requestPermission(HomeMainActivity2.this, PermissionUtils.CODE_WRITE_EXTERNAL_STORAGE,
                mPermissionGrant);
    }
    @Override
