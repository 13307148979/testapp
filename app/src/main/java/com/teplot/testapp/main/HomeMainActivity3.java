 ...
 * 监测界面
 */
public class HomeMainActivity3 extends BaseActivity {
    ...
    private void initHeadView(){
        int height = Utils.getStatusBarHeight(HomeMainActivity3.this);
    ...
    public void showPermissionCONTENT() {
        // type = "1";
        PermissionUtils.requestPermission(HomeMainActivity3.this, PermissionUtils.CODE_WRITE_EXTERNAL_STORAGE,
                mPermissionGrant);
    }
    @Override
